        ...
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="text-center">{{ __('Self Collection Report') }}</h2>
                </div>
                <br>
                <div class="card-body">
                    <form class="form form-horizontal" id="selfCollectionReport" method="POST" action="{{ route('selfCollectionReport') }}" onsubmit="return false;">
                        @csrf
...
<script>
    $(function(){
        ...
        $(document).on('submit','#selfCollectionReport',function(e){
            e.preventDefault();
